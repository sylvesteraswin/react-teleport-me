...
var DelayRenderFactory = function DelayRenderFactory() {
    ...
    return function (DelayComponent) {
        ...
        return _temp2 = _class = function (_Component) {
            _inherits(DelayComponent, _Component);
            ...
            function DelayComponent() {
                ...
                _classCallCheck(this, DelayComponent);

                for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
                    args[_key] = arguments[_key];
                }

                return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DelayComponent.__proto__ || Object.getPrototypeOf(DelayComponent)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
